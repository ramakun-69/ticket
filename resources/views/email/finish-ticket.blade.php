                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __('You have a ticket to close. Here are the ticket details :') }}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td>{{ $ticket->asset->type == 'service' ? __('Service Name') : __('Asset Name') }}
                                                                            </td>
                                                                            <td>:</td>
