...
<body
    ...
    <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#F1F1F1">
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <a href="https://viewstripo.email" target="_blank"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFFFFF;font-size:14px"><img
                                                                            src="https://ajufwj.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/92961521447916451.png"
                                                                            alt
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            width="57" height="13"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __("Support Tickets Can Be Processed. Here are the ticket details :") }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td>{{ $ticket->asset->type == "service" ? __("Service Name") : __("Asset Name") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ $ticket->asset->name }}</td>
                                                                        </tr>
                                                                        @if ($ticket->asset->type != 'service')
                                                                        <tr>
                                                                            <td>{{ __("Asset Number") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ $ticket->asset->code }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ __("Condition") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ __($ticket->condition) }}</td>
                                                                        </tr>
                                                                        @endif
                                                                        <tr>
                                                                            <td>{{ __("Problem Description") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ $ticket->description }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ __("Problem Analysis") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ $ticket->problem_analysis }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ __("Problem Action") }}</td>
                                                                            <td>:</td>
                                                                            <td>{{ $ticket->action }}</td>
                                                                        </tr>
                                                                    </table>
                                                                    ...
                                                                    <p
                                                                        style="text-align: center ;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                                        <a href="{{ $url }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;display:inline-block;background:#E33232;border-radius:50px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center;padding:15px 30px 15px 30px;mso-padding-alt:0;mso-border-alt:10px solid #0d06f6">
                                                                            {{ __("View Ticket") }} </a> <br>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Copyright © {{ date('Y') }} <strong>Erasites
                                                                            Citra Digital Indonesia</strong>, All Rights
                                                                        Reserved.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
