...
@widget('modal',["title"=>__('Department'),"form"=>"pages.master-data.department.form", 'data' =>[], "type" => "" ])
@widget('delete', ["dt" =>true])
@endsection
@push('datatable')
<script>
    var _URL = "{{ route('datatable.mDepartment') }}";
    var _COLUMNS = [
...
@push('js')
<script>
    var _URL_INSERT = "{{ route('master-data.department.store') }}";
    ...
    $("#btn-submit").click(function(e){
      e.preventDefault();
      saveForm($('#form-department'),_URL_INSERT, $('#modalForm'));
    });
</script>
@endpush